...
"}")
        ...
        self.wev_youtube.setObjectName(u"wev_youtube")
        self.wev_youtube.setGeometry(QRect(0, 0, 400, 600))
        self.wev_youtube.setUrl(QUrl(u"https://www.youtube.com/"))
        ...
        self.le_link.setAlignment(Qt.AlignLeading|Qt.AlignLeft|Qt.AlignVCenter)
        self.pb_baixar = QPushButton(self.frame_2)
        self.pb_baixar.setObjectName(u"pb_baixar")
        ...
        self.cb_formt_aqrv.addItem("")
        self.cb_formt_aqrv.setObjectName(u"cb_formt_aqrv")
        ...
        self.download_unitario.setObjectName(u"download_unitario")
        ...
        self.l_thumbnail.setStyleSheet(u"background-color: rgba(0, 0, 0, 0);")
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.download_playlist.setObjectName(u"download_playlist")
        self.lw_playlist_musicas = QListWidget(self.download_playlist)
        self.lw_playlist_musicas.setObjectName(u"lw_playlist_musicas")
        ...
        self.lw_playlist_musicas.setEditTriggers(QAbstractItemView.NoEditTriggers)
        ...
        self.l_vin1_back.setObjectName(u"l_vin1_back")
        ...
        self.l_vin1_back.setStyleSheet(u"font: 700 italic 18pt \"Times New Roman\";\n"
"background-color: rgba(255, 255, 255, 0);")
        self.l_vin1_back.setAlignment(Qt.AlignCenter)
        self.l_vin1_back2 = QLabel(self.frame_2)
        self.l_vin1_back2.setObjectName(u"l_vin1_back2")
        self.l_vin1_back2.setGeometry(QRect(-3, 122, 391, 71))
        self.l_vin1_back2.setFont(font3)
        self.l_vin1_back2.setStyleSheet(u"font: 700 italic 18pt \"Times New Roman\";\n"
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.l_backgroud_gif.setObjectName(u"l_backgroud_gif")
        self.l_backgroud_gif.setGeometry(QRect(0, 0, 400, 600))
        self.l_vin1_front = QLabel(self.frame_2)
        self.l_vin1_front.setObjectName(u"l_vin1_front")
        self.l_vin1_front.setGeometry(QRect(-20, 120, 430, 70))
        self.l_vin1_front.setFont(font3)
        self.l_vin1_front.setStyleSheet(u"font: 700 italic 18pt \"Times New Roman\";\n"
"background-color: rgba(255, 255, 255, 0);")
    ...
    def retranslateUi(self, Janela):
        Janela.setWindowTitle(QCoreApplication.translate("Janela", u"VYTDownload", None))
        self.pb_baixar.setText(QCoreApplication.translate("Janela", u"Baixar", None))
        self.cb_formt_aqrv.setItemText(0, QCoreApplication.translate("Janela", u"MP4", None))
        self.cb_formt_aqrv.setItemText(1, QCoreApplication.translate("Janela", u"MP3", None))

        self.l_thumbnail.setText("")
        self.l_minutos.setText("")
        self.l_vin1_back.setText(QCoreApplication.translate("Janela", u"<html><head/><body><p align=\"center\"><span style=\" font-size:36pt; color:#ad5287;\">Developed by Vi-n1</span></p></body></html>", None))
        self.l_vin1_back2.setText(QCoreApplication.translate("Janela", u"<html><head/><body><p align=\"center\"><span style=\" font-size:36pt; text-decoration: underline; color:#aaaaff;\">Developed by Vi-n1</span></p></body></html>", None))
        self.l_backgroud_gif.setText("")
        self.l_vin1_front.setText(QCoreApplication.translate("Janela", u"<html><head/><body><p align=\"center\"><a href=\"https://github.com/vi-n1\"><span style=\" font-size:36pt; text-decoration: underline; color:#000000;\">Developed by Vi-n1</span></a></p></body></html>", None))
    # retranslateUi
